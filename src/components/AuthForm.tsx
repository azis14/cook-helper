...
export const AuthForm: React.FC<AuthFormProps> = ({ onSuccess }) => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error) throw error;
      // Note: Google OAuth will redirect, so onSuccess might not be called immediately
    } catch (err) {
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
          ...
          <button
            ...
            className="w-full mb-4 flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
          >
